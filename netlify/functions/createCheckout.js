...
const CATALOG = {
  ...
  p1: { name: process.env.PRODUCT_P1_NAME || 'Produit 1', amount: Number(process.env.PRODUCT_P1_AMOUNT || 1999) },
  p2: { name: process.env.PRODUCT_P2_NAME || 'Produit 2', amount: Number(process.env.PRODUCT_P2_AMOUNT || 2999) },
  p3: { name: process.env.PRODUCT_P3_NAME || 'Produit 3', amount: Number(process.env.PRODUCT_P3_AMOUNT || 3999) },
  p4: { name: process.env.PRODUCT_P4_NAME || 'Produit 4', amount: Number(process.env.PRODUCT_P4_AMOUNT || 4999) },
}
